...
def send_email(toaddr, resume_path, filename):
    ...
    email_subject = "Java Full Stack with Angular | 8-YoE | NP Serving | Resume - Gaurav Talele"
    ...
    <body style=" font-family: Arial, Helvetica, sans-serif; font-size: 22px">
        ...
        <h5>I hope you are doing well. <h5>
                ...
                <table style="font-weight: normal; line-height: 24px;" border=1>
                    ...
                    <tr>
                        <td style="font-weight: bold;">Total YoE</td>
                        <td>8.5 Years</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>30 LPA (All Fixed)</td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;">Expected CTC</td>
                        <td>32 LPA</td>
                    </tr>
                    <tr>
                        <td style="font-weight: bold;">Preferable Time for an Interview</td>
                ...
                <p style="line-height: 22px; font-weight: normal;">
                    ...
                    [M]: epostgauravtalele@gmail.com<br>
                    [H]: +91-9969351313
                    <br>
                </p>
    </body>
...
if os.path.exists(csv_path):
    with open(csv_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            to_add = row['Email']
            resume_path = "./cv_Sr_Java_Full_Stack_GauravTalele-8-YoE.pdf"
            filename = "cv_Sr_Java_Full_Stack_GauravTalele-8-YoE.pdf"
